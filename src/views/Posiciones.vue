  ...
  <div class="min-vh-100 bg-black text-white">
    <div class="container-fluid px-0">
      <div class="row g-0">
        <!-- SIDEBAR -->
        <aside
          class="col-12 col-lg-3 col-xl-2 bg-black border-end border-success border-opacity-25"
        >
          <Sidebar />
        </aside>

        <!-- CONTENIDO -->
        <main class="col-12 col-lg-9 col-xl-10 min-vh-100 ps-1 pe-4 pt-1 pb-4">
            ...
            <div class="row g-4 mb-4">
              ...
              <div class="col-12 col-md-6 col-xl-3">
                <div class="card prediction-card text-white rounded-4">
                  <div class="card-body p-2">
                    <div class="d-flex align-items-center gap-2 mb-2">
                      <PhTarget size="16" weight="fill" class="text-success" />
                  ...
                  <div class="card prediction-card text-white rounded-4">
                    <div class="card-body p-3">
                      ...
                      <div class="row g-3">
                        ...
                        <div class="col-6">
                          <div class="bg-dark rounded-4 p-2 h-100">
                            <small class="text-white-50"> Predicciones </small>
...
const getPositionBadge = (rank) => {
  ...
  if (rank === 3) return "text-bg-warning";
